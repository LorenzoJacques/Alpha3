...
def get_type() : #Récupère la valeur du potentiomètre et retourne 0, 10 ou 20 selon sa position
	...
	if 20<adcout<555 : #Si la valeur du potentiomètre augmentait proportionnellement à la distance parcourue, les ratios serianet 0-333-666-1024. Mais ce n'est pas le cas, et les valeurs utilisés sont celles divisant empiriquement la distance totale en 3
		return 0
	if 555<adcout<791 :
		return 10
	if 791<adcout<1030 :
